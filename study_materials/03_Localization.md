...
```
<p align="center">
    <img src=../assets/lesson_03/clean_rviz.png width=400/>
</p>
...
<p align="center">
    <img src=../assets/lesson_03/rviz_house.png width=400/>
</p>
...
Давай сделаем свой конфиг в пакете для узла `gmapping`. Создаём папку `config` внутри пакета. Внутри этой папки создаём файл `gmapping_params.yaml`.
